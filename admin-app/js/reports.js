...
document.addEventListener("DOMContentLoaded", () => {
  ...
  downloadPdfReportBtn.addEventListener("click", () => {
    ...
    doc.setFontSize(18);
    doc.text("RsWallet User Report", 10, 20);
    doc.setFontSize(10);
    ...
    doc.save(`RsWallet_Report_${new Date().toISOString().split("T")[0]}.pdf`);
  });
  ...
  downloadCsvReportBtn.addEventListener("click", () => {
    ...
    a.href = url;
    a.download = `RsWallet_Report_${new Date().toISOString().split("T")[0]}.csv`;
    a.click();
